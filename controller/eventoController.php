...
class eventoController extends Controller {    
    ...
    public function edit() {
        ...
        $data['obj'] = $obj;
         ...
         if($_SESSION['perfil']=='PROFESOR'){$WHERE=" where tipo_evento.idtipo_evento=1";} ;
...
//        $dep=$this->mostrar_Facultad_idUsusario($_SESSION['idusuario']);
        ...
        $data['tipo_evento']="<input type='hidden' id='idtipo_evento' name='idtipo_evento' value='".$code."'><strong>egre".$label."</strong>";
