<script type="text/javascript" src="js/app/evt_form_eventoPS.js"  ></script>
...
label {
   ...
   text-align: left;
    ...
    <a href="index.php?controller=eventoPS" class="btn btn-primary glyphicon glyphicon-backward">ATRAS</a>
