...
<h6 class="ui-widget-header">Registro de Desarrolladores</h6>
<div class="container">
	<br>
		<div class="row" style="">
			<div class="col-md-4">			
			...
			<div class="col-md-4" style="border: 1px solid #D5D5D5; padding-left: 8px; padding-right: 8px; border-radius: 3px;">
				<form id="frm" action="index.php" method="POST">
                                <input type="hidden" name="controller" value="desarrolladores_web" />
                                <input type="hidden" name="action" value="save" />
				<br>
				<fieldset>
				<legend>Fornulario Noticias</legend>
                                <input id="id_desarrolladoresweb" name="id_desarrolladoresweb" class="text ui-widget-content ui-corner-all" style=" width: 50px; text-align: left;" value="<?php echo $obj->id_desarrolladoresweb; ?>" readonly />
					...
					<div class="form-group">
						...
						<label class="cabinet">
						<input id="imagen" name="imagen" type="file" class="file" value="<?php echo $obj->imagen; ?>" />
						</label>
					</div>
					<div class="col-md-12">
					<div class="col-md-1">
					...
					<div class="col-md-10">
                                            ...
                                            <a href="index.php?controller=desarrolladores_web" class="button">ATRAS</a>
                                        </div>
