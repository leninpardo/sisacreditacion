...
//            "scrollY": "200px",
        ...
        $(".sub_evento").click(function(){
            ...
            $.post('index.php', 'controller=asignacionactividadPS&action=asignaractividadPS&idevento='
...
<div id="dos"><span style="color:blue;font-size: 18px;">LISTA DE SUB EVENTOS DE PS:</span>
    <div align="left">
        <span id="tabla">
