...
<!--           <table border='1'>
               <tbody>
                   ...
                   <?php $con=1; foreach ($rows3 as $key => $value) { 
                       if($con<=4){?>
 ...
 echo     '<div class="col-md-6" style=" padding-right: 3px; padding-left: 10px; ">
                <div>
					...
					<div class="view view-first">
							<img style="width:100%; height:110px;"class="img-responsive" src="../web/images/'.$value[3].'" alt="" />
							<div class="mask">
...
$con=1; foreach ($rows3 as $key => $value) { 
			 ...
			 echo'<div><div id="bloque_2_titgen" class="col-md-12">
					...
					<h4 style="text-align : justify; font-family:Calibri; font-size: 12px; color:#CECFCF;">
						...
						<img style="width:100%; height:210px;"class="img-responsive" src="../web/images/'.$value[3].'"alt="">
