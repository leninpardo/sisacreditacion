    ...
    $('#t_evntoEU_alumno2').DataTable({
       ...
       $('#t_evntoEU_alumno3').DataTable({
        ...
        $("#seleccionado").change(function() {
         ...
         $.post('index.php', 'controller=asistenciaalumnoPS&action=asistenciaPS&seleccionado='+seleccionado+'&idevento='+idevento, function(data) {
            console.log(data);
...
<a href="index.php?controller=asistenciaalumnoPS" class="btn btn-primary glyphicon glyphicon-backward">ATRAS</a>
...
<div id="tabs">
    ...
    <div class="contFrm ui-corner-all" style="background: #fff;">
        <div class="contenido" style="margin:0 auto; width: 100%; ">
            <fieldset class="ui-corner-all" >
                <legend align="left" style="font-family: georgia;">Asistencia Profesor</legend> 
                ...
                <span id="guardoc" style="display: none">GUARDANDO...</span>
                  <input type="button" class="btn btn-info" name="guardar1" id="guardar1" value="GUARDAR">
            </fieldset> 
        </div>
    </div>
</form>
   ...
   <form id="frm2" action="index.php" method="POST">
    ...
    <div class="contFrm ui-corner-all" style="background: #fff;">
        <div class="contenido" style="margin:0 auto; width: 100%; ">
            <fieldset class="ui-corner-all" >
                <legend align="left" style="font-family: georgia;">Asistencia Alumnos</legend> 
                ...
                <span id="guaralum" style="display: none">GUARDANDO...</span>
                 <input type="button" class="btn btn-info" name="guardar2" id="guardar2" value="GUARDAR">
            </fieldset> 
        </div>
    </div>
</form>
   ...
   <form id="frm3" action="index.php" method="POST">
    ...
    <div class="contFrm ui-corner-all" style="background: #fff;">
        <div class="contenido" style="margin:0 auto; width: 100%; ">
            <fieldset class="ui-corner-all" >
                <legend align="left" style="font-family: georgia;">Asistencia de Otros</legend> 
