...
//            "scrollY": "200px",
        ...
        $(".sub_evento").click(function(){
            ...
            $.post('index.php', 'controller=asistenciaalumnoEU&action=asistenciaEU&idevento='
...
<div id="dos"> <a href="index.php?controller=asistenciaalumnoEU" class="btn btn-primary glyphicon glyphicon-backward">ATRAS</a><span style="color:blue;font-size: 18px;">CRONOGRAMA</span>
