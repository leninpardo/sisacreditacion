...
<style>
    ...
    <div id="dialogo2" style="" title="ACEPTAR">
        <form  action="index.php" id="frm" method="POST">
            <input type="hidden" name="controller" value="solicitudes_eu" />
            <input type="hidden" name="action" value="save" />
<!--             <input type="hidden" name="controller" value="solicitudes_ps" />
           <input type="hidden" name="action" value="insertarDetalle_asistencia_alumnos" />-->
