    ...
    $('#t_evntoEU_alumno2').DataTable({
       ...
       $('#t_evntoEU_alumno3').DataTable({
        ...
        $("#seleccionado").change(function() {
         ...
         $.post('index.php', 'controller=asistenciaseventoPS&action=asistenciaPS&seleccionado='+seleccionado+'&idevento='+idevento, function(data) {
            console.log(data);
...
<a href="index.php?controller=asistenciaseventoPS" class="btn btn-primary glyphicon glyphicon-backward">ATRAS</a>
...
<div id="tabs">
   ...
   <div class="div_container">
    ...
    <input type="hidden" name="controller" value="asistenciaseventoPS" />
