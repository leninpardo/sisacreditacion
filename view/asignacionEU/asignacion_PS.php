...
//            "scrollY": "200px",
        ...
        $(".dialog-link").click(function() {
            ...
            $.post('index.php', 'controller=asignacionEU&action=lista_cursosxcursos&curso_profesor=' + curso_profesor+'&idevento='+idevento, function(data) {
                console.log(data);
...
//        alert(cod_prof+','+cargo+','+costo+','+curso);
            ...
            $.post('index.php', 'controller=asignacionEU&action=save_profesor_alumno&cod_prof=' + cod_prof + '&cargo=' + cargo + '&costo=' + costo + '&curso=' + curso + '&idevento=' + idevento + '&check=' + cheket, function(data) {
            });
            $.post('index.php', 'controller=asignacionEU&action=listado_alumnos_ps1&idevento='
        ...
        $(".altualizar_externo").click(function() {
            ...
            $.post('index.php', 'controller=asignacionEU&action=save_externo&idevento=' + idevento + '&id_externo=' + id_externo + '&costo=' + cost + '&cargo=' + cargon + '&check=' + cheket, function(data) {
            });
        ...
        $("#acc").click(function() {
            ...
            $("#texlumno").fadeIn(100);
            $.post('index.php', 'controller=asignacionEU&action=actualizar_alumno&' + str + '&idevento=' + idevento, function(data) {
        ...
        $("#guardar_externos").click(function() {
            ...
            $.post('index.php', 'controller=asignacionEU&action=agregar_externo&' + ser + '&idevento=' + idevento, function(data) {
            });
            $.post('index.php', 'controller=asignacionEU&action=listado_exter_ps&idevento='+ idevento, function(data) {
                console.log(data);
...
<a href="index.php?controller=asignacionEU" class="button">ATRAS</a>
...
//                            echo "</select>";
                            ?></td>
                            <td><input type="checkbox" id="asignado<?php echo $value['CodigoProfesor']; ?>" <?php echo $chekP; ?> value="1"></td>
                            <td><a curso_profesor='<?php echo $value['CodigoProfesor']; ?>' class="dialog-link glyphicon glyphicon-list"></a><input type="hidden" id="cursos_a_guardar_<?php echo $value['CodigoProfesor'] ?>"></td>
                            <td>&nbsp;&nbsp;&nbsp;<a  profesor='<?php echo $value['CodigoProfesor']; ?>' style="cursor:pointer;"class="guardar_alumnos_PS glyphicon glyphicon-floppy-disk"></a><span id="msj_guardado_<?php echo $value['CodigoProfesor'] ?>"></span></td>
                        </tr>
...
//                                    echo "</select>";
                                ...
                                <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a  externo='<?php echo $value['id_externos']; ?>' style="cursor:pointer;"class="bajar_actualizar glyphicon glyphicon-repeat"></a></td>
                            </tr>
