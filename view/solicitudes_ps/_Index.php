...
<script type="text/javascript" src="js/app/evt_form_solicitudes_ps.js" ></script>
<h6 class="ui-widget-header">Listado de solicitudes de alumnos</h6>
