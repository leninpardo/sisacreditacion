...
<script type="text/javascript" src="js/app/evt_form_solicitudes_docentes_ps.js" ></script>
<h6 class="ui-widget-header">Listado de solicitudes de docentes</h6>
<div class="container-fluid" style="overflow-y: auto; min-height: 390px">
  ...
  <div id="tabla2">
    ...
    <?php echo $solicitudes_docentes_eu; ?>
    </div>
