<script type="text/javascript" src="js/app/evt_form_eventoEU.js"  ></script>
...
label {
   ...
   text-align: left;
    ...
    <a href="index.php?controller=eventoEU" class="btn btn-primary glyphicon glyphicon-backward">ATRAS</a>
