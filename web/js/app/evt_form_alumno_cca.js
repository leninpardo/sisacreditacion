...
$(function() {
 ...
 function nuevoalumno_cca(a,b,c,d,e,f,g){
        alert ("El alumno :"+b+' '+c+' '+d+" sera matriculado en CCA");
        
            
            window.location='index.php?controller=alumno_cca&action=create&nombre='+b+'&apellidop='+c+'&apellidom='+d+'&dni='+e+'&sexo='+f+'&parametro='+g;
