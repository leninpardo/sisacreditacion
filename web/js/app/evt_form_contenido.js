...
$(function() {
   ...
   $.post('index.php','controller=escuelaprofesional&action=getEscuelaProfesional&CodigoFacultad='+ids,function(data){
    ...
    $("#CodigoSemestre").change(function(){
        ...
        var ids = $(this).val();
        $.post('index.php','controller=listaproyecto&action=Parametros&CodigoSemestre='+ids,function(data){
            console.log(data);
       ...
       $("#CodigoFacultad").change(function(){
        var id = $(this).val();
        $.post('index.php','controller=listaproyecto&action=Parametros_facultad&CodigoFacultad='+id,function(data){
            console.log(data);
            $("#tabla").empty().append(data);
        });
    });
