...
echo '<div class="item active">
      				<img style="width: 800px; height:200px;" src="'.$value[0].'" alt="...">
 ...
 onClick="document.getElementById('detalle').style.visibility='visible',document.getElementById('tabla').style.visibility='hidden'"> 
    <br><div id="tabla">Este es datatable</div> 
<div id="detalle" style="visibility:hidden"> 
Este es el detalle de proyecto
<input type="button" value="Salir" 
 onClick="document.getElementById('detalle').style.visibility='hidden',document.getElementById('tabla').style.visibility='visible'"> 
</div> 
 ...
 echo '<div class="col-md-5">';
            	 for($j=0;$j<4;$j++) 
						{
 echo     '<div class="col-md-6" style=" padding-right: 3px; padding-left: 10px; ">
                <div>
                    <div id="bloque_3_titgen" class="col-md-12">
						...
						<h3 style="font-family:Calibri; font-size: 15px; color:white; text-align:left; margin-top:5px;">
								<a class="" href="">
								<b>'.utf8_encode(substr($noticias[$j]["titulo"],0,52)).'...</b></a>
	                                            
						</h3>
						</div>
					</div>
					<div class="view view-first">
							<img style="width:100%; height:110px;"class="img-responsive" src="'.$noticias[$j]["imagen"].'" alt="" />
							<div class="mask">
							<p>'.utf8_encode(substr($noticias[$j]["descripcion"],0,130)).' ...</p>
		...
		<div class="col-md-5" style=" height:390px; padding-left: 3px;">
			 <div><div id="bloque_2_titgen" class="col-md-12">
					...
					<h3 style="font-family:Calibri; font-size: 22px; color:white; text-align:left; margin-top:5px;">
							<a class="" href="">
							<b>'.utf8_encode(substr($noticias[$j]["titulo"],0,100)).'...</b></a>
					</h3>
					<h4 style="text-align : justify; font-family:Calibri; font-size: 12px; color:#CECFCF;">
						'.utf8_encode(substr($noticias[$j]["descripcion"],0,225)).'...
					</h4>
					</div>
					</div>
					
						<img style="width:100%; height:210px;"class="img-responsive" src="'.$noticias[$j]["imagen"].'"alt="">
...
echo '
			    ...
			    <div><div id="bloque_3_titgene" class="col-md-12">
					...
					<h3 style="font-family:Calibri; font-size: 15px; color:white; text-align:left; margin-top:5px;">
							<a class="" href="">
							<b>'.utf8_encode(substr($noticias[$j]["titulo"],0,48)).'...</b></a> 
					</h3>
					</div>
					</div>
						...
						<div class="view2 view-first">
							<img style="width:100%; height:110px;"class="img-responsive" src="'.$noticias[$j]["imagen"].'" alt="" />
							<div class="mask">
							<p>'.utf8_encode(substr($noticias[$j]["descripcion"],0,120)).' ...</p>
								<a href="#" class="info">LEER MAS</a>
							</div>
						</div>
        ...
        <div class="col-md-12" style="background-color: #fff; padding-right: 3px; margin-top: 8px;">
            <div class="col-md-8" style="padding-left: 0; height: 680px; margin-top: 8px; margin-bottom: 8px; ">
                <div class="col-md-12" style="background-color: #FFF; height: 510px;">
                    <?php 
                    echo ' <div class="header_01">'.utf8_encode($contenido[0]["titulo"]).'</div>
                <p style="text-align: justify; font-family: Calibri; font-size: 13px;">'.utf8_encode($contenido[0]["descripcion"]).'</p>
                <center><div class="section_01" style="background-color: #CFCFCF;">
                    <p style="text-align: center; font-style:italic;; font-size: 12px;">
					<strong>Misión </strong><br>
					
					<br>
'.utf8_encode($contenido[0]["mision"]).'
					<BR><br>
					<strong>Visión </strong><br><br>
					'.utf8_encode($contenido[0]["vision"]).'
					</p>               
                </div></center>
                ...
                <div style="height: 400px;width: 320px; overflow-y: auto; margin-top: 5px;">
                	...
                	<?php
                    	...
                    	<div class="news_date_2">
                        	<span><?php 
                        	$fecha = new DateTime($valor["fecha"]);
							echo $fecha->format("d");?></span> <span><?php  echo  strtoupper($fecha->format("M")); ?></span> 
                        	                        </div>
                        <div class="news_content_2">
                        	<div class="header_05_2"><a href="#"><?php echo utf8_encode($valor["titulo"]); ?></a></div>
                            <p style="font-size:12px; font-family: Calibri;"><?php echo utf8_encode(substr($valor["descripcion"],0,100))."..."; ?></p>
                        </div>
...
input::-webkit-validation-bubble-arrow {
	...
	<?php 
 foreach ($desarrolladores as $key => $value) {
 	echo '<div class="mosaicflow__item" >
			<img width="100" height="150" src="'.$value["imagen"].'"  alt="ING VALLES">
