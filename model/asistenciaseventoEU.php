...
class asistenciaseventoEU extends Main {
 ...
 Inner Join clasificacion_evento ON clasificacion_evento.id_clasificacion_evento = tipo_evento.id_clasificacion_evento
    where  evento.CodigoSemestre='" . $semestre_ultimo . "' and  tipo_evento.idtipo_evento= 6 and evento.idevento_padre is null and " . $c . " like :query";
